...
HD_PWD='C:/Users/james/ETS/Hiver_2024/ELE739/ELE739-Projet_2/Projet_2/Projet_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Exp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Exp.tcl -notrace
